...
( cd usr/libLIBDIRSUFFIX/vdpau ; rm -rf libvdpau_nvidia.so )
( cd usr/libLIBDIRSUFFIX/vdpau ; ln -sf libvdpau_nvidia.so.PKGVERSION libvdpau_nvidia.so )
...
( cd usr/libLIBDIRSUFFIX ; ln -sf tls/libnvidia-tls.so.PKGVERSION libnvidia-tls.so.1 )
...
( cd usr/libLIBDIRSUFFIX ; ln -sf vdpau/libvdpau_nvidia.so.PKGVERSION libvdpau_nvidia.so )
