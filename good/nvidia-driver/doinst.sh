...
( cd usr/libLIBDIRSUFFIX ; rm -rf libvdpau.so )
( cd usr/libLIBDIRSUFFIX ; ln -sf libvdpau.so.1 libvdpau.so )
( cd usr/libLIBDIRSUFFIX ; ln -sf libvdpau.so.PKGVERSION libvdpau.so.1 )
...
( cd usr/libLIBDIRSUFFIX ; rm -rf libvdpau_trace.so )
( cd usr/libLIBDIRSUFFIX ; ln -sf libvdpau_trace.so.PKGVERSION libvdpau_trace.so )
